SELECT
    ...
    a.year,
    a.week,
    sum(excess_adj_mortality_capita) * pop_0_24_all / 100000 AS excess_ttl
FROM
    (
        SELECT
            a.state,
        ...
        FROM
            (
                SELECT
                    ...
                    year,
                    week,
                    adj_mortality_0_24 AS adj_mortality,
                    pop_0_24 AS pop
                FROM
            ...
            JOIN (
                SELECT
                    `state`,
                    week,
                    AVG(adj_mortality_0_24) AS adj_mortality_baseline
                FROM
                    deaths.adj_mortality_week
                WHERE
